...
def box_plot_svg(
    ...
    margin_left = max(62.0, y_axis_title_size * 1.35 + y_label_width + 26.0)
    ...
    label_angle = _label_angle(max_x_label_width, slot, x_label_size)
    ...
    margin_bottom = max(72.0, label_offset + label_height + x_axis_title_size * 1.35 + 24.0)

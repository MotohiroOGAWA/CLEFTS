...
The fixed bottom-right Run button becomes available when dataset validation and required settings are complete. Red text lists unmet requirements. The backend validates settings again before launching processing.

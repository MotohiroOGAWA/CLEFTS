...
function cleavagePatternSetSavePath(name, previousPath) {
  ...
  const filename = ensureFileSuffix(stem, cleavagePatternSetEditor.FILE_SUFFIX);
...
function manifestTableHtml(manifest, index) {
  const columns = ['file', 'status', 'smiles', 'num_input_records', 'num_valid_samples', 'rejected_sample_count', 'rejection_log', 'num_nodes', 'num_edges', 'assignment_score', 'assignment_score_without_precursor'];

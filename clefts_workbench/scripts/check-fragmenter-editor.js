...
const { ensureFileSuffix } = extension.exports;
assert.equal(ensureFileSuffix('pattern', '.cleavage.json'), 'pattern.cleavage.json');
assert.equal(ensureFileSuffix('pattern.json', '.cleavage.json'), 'pattern.cleavage.json');
assert.equal(ensureFileSuffix('pattern.cleavage.json', '.cleavage.json'), 'pattern.cleavage.json');
assert.equal(ensureFileSuffix('pattern.cleavage.json.cleavage.json', '.cleavage.json'), 'pattern.cleavage.json');
assert.equal(ensureFileSuffix('pattern.CLEAVAGE.JSON', '.cleavage.json'), 'pattern.CLEAVAGE.JSON');
assert.equal(ensureFileSuffix('legacy.clevage.json', '.cleavage.json', ['.clevage.json']), 'legacy.clevage.json');
assert.equal(ensureFileSuffix('set.clevageset.json.clevageset.json', '.clevageset.json'), 'set.clevageset.json');
